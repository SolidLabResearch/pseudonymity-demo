...
describe('Use case: Sign-Verify (alice: WebIdOnWebIdActor; others are SolidVCActors)', (): void => {
    ...
    const webIdOnWebIdActorFactory = new WebIdOnWebIdActorFactory(defaultDocumentLoaderCacheOptions)
    let alice: WebIdOnWebIdActor
    ...
    beforeAll(async (): Promise<void> => {
        ...
        alice = await webIdOnWebIdActorFactory.createInitializedActor(
            aliceRecord,
            pseudoRecord
        )
